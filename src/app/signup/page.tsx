  ...
  return(
    ...
    <div className="bg-no-repeat bg-cover bg-center relative">
      ...
      <div className="flex mx-auto p-10 justify-center"> 
        {/* 會員註冊頁左圖 */}
        <div className="flex-col flex p-12 z-10">
              ...
              <div className="relative space-y-5">
                ...
                <div>
                  <label
                    ...
                    className="block mb-2  text-base font-medium text-gray-900 focus:outline-none focus:border-sisal-300"
                  >
                    再次輸入密碼
                  </label>
                  <input
                ...
                <button
                  type="submit"
                  className="w-full text-white bg-sisal-400 hover:bg-sisal-700 focus:ring-4 font-medium rounded-lg text-base px-5 py-3 text-center"
                >註冊帳號
                </button>
